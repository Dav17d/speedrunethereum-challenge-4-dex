      ...
      <Switch>
        <Route exact path="/">
          ...
          <div style={{ width: 800, margin: "auto", marginTop: 64 }}>
              ...
              renderItem={item => {
                return (
                  <List.Item key={item.blockNumber}>
                    <Address value={item.args[0]} ensProvider={localProvider} fontSize={16} /> swapped
                    <Balance value={item.args[1]} />
                    ETH to get
                    <Balance value={item.args[2]} />
                    amount of tokens
                  </List.Item>
                );
              }}
            ...
            />
            <List
              dataSource={LiquidityProvidedEvents}
              renderItem={item => {
                return (
                  <List.Item key={item.blockNumber}>
                    <Address value={item.args[0]} ensProvider={localProvider} fontSize={16} /> provided
                    <Balance value={item.args[1]} />
                    amount of LP tokens
                  </List.Item>
                );
            ...
            />
            {/* <List
              dataSource={LiquidityRemovedEvents}
              renderItem={item => {
                return (
                  <List.Item key={item.blockNumber}>
                    <Address value={item.args[0]} ensProvider={localProvider} fontSize={16} /> removed
                    <Balance value={item.args[1]} />
                    amount of LP tokens
                  </List.Item>
                );
